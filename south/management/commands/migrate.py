...
class Command(BaseCommand):
    option_list = BaseCommand.option_list + (
        ...
        make_option('--autofake-first', action='store_true', dest='autofake_first', default=False,
            help="Automatically fake the first migration if it can be detected that an app already has database tables."),
    ...
    def handle(self, app=None, target=None, skip=False, merge=False, backwards=False, fake=False, autofake_first=False, db_dry_run=False, show_list=False, show_changes=False, database=DEFAULT_DB_ALIAS, delete_ghosts=False, ignore_ghosts=False, **options):
